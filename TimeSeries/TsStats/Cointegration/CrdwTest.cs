...
namespace HC.Analytics.TimeSeries.TsStats.Cointegration
{
    ...
    public static class CrdwTest
    {
            ...
            out double dblTestValue)
        {
            ...
            return CrdwCriticalValues.TestIsStationary(dblTStat,
                                                       dblConfidence,
                                                       errors.Count,
                                                       out dblTestValue);
        }
        ...
        public static void Test1()
        {
            ...
            double dblTStat;
            double dblTestValue;
            bool blnIsItStationary = CheckIsStationary(
                xValues,
                0.05,
                out dblTStat,
                out dblTestValue);

            if (blnIsItStationary)
            {
                throw new Exception("Invalid result");
            }
            Console.WriteLine(blnIsItStationary);
        }
        ...
        public static void Test3()
        {
            ...
            double dblTestValue;
            bool check = CheckIsStationary(data,
                                           out dblTStat,
                                           dblConfidence,
                                           out dblTestValue);
