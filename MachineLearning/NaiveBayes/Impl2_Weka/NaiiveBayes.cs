...
namespace HC.Analytics.MachineLearning.NaiveBayes.Impl2_Weka
{
    ...
    public class NaiveBayes : Classifier
    {
         ...
         */
        protected bool m_UseKernelEstimator = false;

        /**
         * Whether to use discretization than normal distribution
         * for numeric attributes
         */
        protected bool m_UseDiscretization = false;
        ...
        protected static double DEFAULT_NUM_PRECISION = 0.01;
        ...
        public override void buildClassifier(Instances instances)
        {
            ...
            //true);
            int attIndex = 0;
            FastVector.FastVectorEnumeration enu = m_Instances.enumerateAttributes();
            ...
            // Compute counts
            FastVector.FastVectorEnumeration enumInsts = m_Instances.enumerateInstances();
        ...
        public void updateClassifier(Instance instance)
        {
            ...
            {
                FastVector.FastVectorEnumeration enumAtts = m_Instances.enumerateAttributes();
                int attIndex = 0;
        ...
        public double[] distributionForInstance(Instance instance)
        {
            ...
            FastVector.FastVectorEnumeration enumAtts = instance.enumerateAttributes();
            int attIndex = 0;
            while (enumAtts.hasMoreElements())
            {
                Attribute attribute = (Attribute)enumAtts.nextElement();
         ...
         */
        public IEnumerator listOptions()
        {

            ArrayList newVector = new ArrayList(2);
        ...
        public void setOptions(string[] options)
        {
            ...
            bool k = Utils.getFlag('K', options);
            bool d = Utils.getFlag('D', options);
            if (k && d)
            {
                throw new Exception("Can't use both kernel density " +
        ...
        public string ToString()
        {
            ...
            else
            {
                try
                {
                    for (int i = 0; i < m_Distributions.GetLength(1); i++)
                    {
                        text.Append("\n\nClass " + m_Instances.classAttribute().value(i) +
                                ": Prior probability = " +
                                m_ClassDistribution.getProbability(i) + "\n\n");
                        FastVector.FastVectorEnumeration enumAtts = m_Instances.enumerateAttributes();
                        int attIndex = 0;
                        while (enumAtts.hasMoreElements())
                        {
         ...
         */
        public bool getUseKernelEstimator()
        {
         ...
         */
        public void setUseKernelEstimator(bool v)
        {
         ...
         */
        public bool getUseSupervisedDiscretization()
        {
         ...
         */
        public void setUseSupervisedDiscretization(bool newblah)
        {
        ...
        public static void main(string[] argv)
        {
            ...
            try
            {
                //PrintToScreen.WriteLine(Evaluation.evaluateModel(new NaiveBayes(), argv));
            }
            catch (Exception e)
            {
