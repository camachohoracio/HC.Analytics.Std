...
namespace HC.Analytics.MachineLearning.NaiveBayes.Impl2_Weka
{
    ...
    public class NormalEstimator : Estimator
    {
        ...
        {
            return Math.Round((data / m_Precision) * m_Precision, 0);
        }
        ...
        public double getProbability(double data)
        {
            ...
            double pLower = UnivNormalDistStd.CdfStatic(zLower);
            double pUpper = UnivNormalDistStd.CdfStatic(zUpper);
        ...
        public string ToString()
        {
            ...
            return "Normal Distribution. Mean = " + m_Mean
              + " StandardDev = " + m_StandardDev
              + " WeightSum = " + m_SumOfWeights
              + " Precision = " + m_Precision + Environment.NewLine;
        }
        ...
        public static void main(string[] argv)
        {
            ...
            try
            {
                ...
                {
                    double current = Double.Parse(argv[i]);
