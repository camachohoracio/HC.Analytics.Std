...
namespace HC.Analytics.MachineLearning.NaiveBayes.Impl2_Weka
{
    ...
    public abstract class Classifier
    {
        ...
        public double classifyInstance(Instance instance)
        {
            ...
            {
                case HC.Analytics.MachineLearning.NaiveBayes.Impl2_Weka.Attribute.NOMINAL:
                    double max = 0;
                    int maxIndex = 0;
                ...
                case HC.Analytics.MachineLearning.NaiveBayes.Impl2_Weka.Attribute.NUMERIC:
                    return dist[0];
                default:
                    return Instance.missingValue();
            }
        ...
        {
            return (Classifier)ClonerHelper.Clone(model);
        }
                           ...
                           int num)
        {
            ...
            {
                classifiers[i] = (Classifier)ClonerHelper.Clone(model);
            }
            return classifiers;
        }
        ...
        public IEnumerator listOptions()
        {
            ...
            ArrayList newVector = new ArrayList(1);
