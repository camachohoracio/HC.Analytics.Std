 ...
 * methods. Replaces java.util.ArrayList. (Synchronized methods tend to
 * be slow.)
 *
...
namespace HC.Analytics.MachineLearning.NaiveBayes.Impl2_Weka
{
    ...
    public class FastVector
    {
        ...
        public class FastVectorEnumeration
        {
            ...
            // These JML commands say how m_Counter implements IEnumerator
            //@ in moreElements;
             ...
             */
            public  /*@pure@*/ bool hasMoreElements()
            {
        ...
        public Object copyElements()
        {
            ...
            {
                copy.m_Objects[i] = ClonerHelper.Clone(m_Objects[i]);
            }
            return copy;
        }
        ...
        public  /*@pure@*/ Object elementAt(int index)
        {
         ...
         */
        public  /*@pure@*/ FastVectorEnumeration elements()
        {
        ...
        public  /*@pure@*/ FastVectorEnumeration elements(int index)
        {
         ...
         * added by akibriya
         */
        public /*@pure@*/ bool contains(Object o)
        {
            if (o == null)
                return false;
         ...
         */
        //@ requires m_Size > 0;
        public  /*@pure@*/ Object firstElement()
        {
         ...
         */
        public  /*@pure@*/ int indexOf(/*@non_null@*/ Object element)
        {
        ...
        public void insertElementAt(Object element, int index)
        {
            ...
            if (m_Size < m_Objects.Length)
            {
                Array.Copy(m_Objects, index, m_Objects, index + 1,
                                 m_Size - index);
            ...
            else
            {
                ...
                Array.Copy(m_Objects, index, newObjects, index + 1,
                         m_Size - index);
                m_Objects = newObjects;
            }
            m_Size++;
         ...
         */
        //@ requires m_Size > 0;
        public  /*@pure@*/ Object lastElement()
        {
        ...
        public void setCapacity(int capacity)
        {
            ...
            Array.Copy(m_Objects, 0, newObjects, 0, Math.Min(capacity, m_Size));
            m_Objects = newObjects;
