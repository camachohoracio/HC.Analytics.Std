 ...
 */
    ...
    [Serializable]
    public class PhysicalConstants : Object
    {
/**
...
//
        ...
        public static double amu_c2 = 931.49432*Units.MeV;

        public static double Avogadro = 6.0221367e+23/Units.mole;
...
//
        public static double c_light = 2.99792458e+8*Units.m/Units.s;
...
//
        public static double e_squared = Units.eplus*Units.eplus;
        public static double electron_charge = - Units.eplus; // see SystemOfUnits.h
...
//
        public static double electron_mass_c2 = 0.51099906*Units.MeV;

//
// electromagnetic coupling = 1.43996e-12 MeV*mm/(eplus^2)
//
        public static double elm_coupling = e_squared/(4*pi*epsilon0);
        public static double epsilon0 = 1.0/(c_squared*mu0);
        public static double fine_structure_const = elm_coupling/hbarc;
        public static double h_Planck = 6.6260755e-34*Units.joule*Units.s;
...
//
//
        public static double k_Boltzmann = 8.617385e-11*Units.MeV/Units.kelvin;

//
//
//
        public static double kGasThreshold = 10.0*Units.mg/Units.cm3;
        public static double mu0 = 4*pi*1.0e-7*Units.henry/Units.m;
        public static double neutron_mass_c2 = 939.56563*Units.MeV;
        public static PhysicalConstants physicalConstants = new PhysicalConstants();

//
// 
//
        public static double pi = Math.PI; //3.14159265358979323846;
        public static double pi2 = pi*pi;
        public static double proton_mass_c2 = 938.27231*Units.MeV;
        public static double STP_Pressure = 1.0*Units.atmosphere;
        public static double STP_Temperature = 273.15*Units.kelvin;
...
//
//
        public static double universe_mean_density = 1.0e-25*Units.g/Units.cm3;
/**
