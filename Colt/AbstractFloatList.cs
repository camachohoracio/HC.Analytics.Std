...
namespace HC.Analytics.Colt
{
    ...
    */
    ...
    [Serializable]
    public abstract class AbstractFloatList : AbstractList
    {
        /**
        ...
        public bool contains(float elem)
        {
        ...
        {
            float[] myElements = new float[m_size];
        ...
        {
            //delta
            if (!(otherObj is AbstractFloatList))
            {
                return false;
            }
            if (this == otherObj)
        ...
        public bool forEach(FloatProcedure procedure)
        {
        ...
        */
        ...
        public bool removeAll(AbstractFloatList other)
        {
            if (other.Size() == 0)
            {
        ...
        */
        ...
        public override void replaceFromWith(int from, CollectionBase other)
        {
            ...
            {
                e.MoveNext();
                set(index++, (float) e.Current); //delta
            }
        }
        ...
        */
        ...
        public bool retainAll(AbstractFloatList other)
        {
            if (other.Size() == 0)
            {
                if (m_size == 0)
         ...
         * For example:
         * public DatabaseList : AbstractFloatList {
         *    ...
