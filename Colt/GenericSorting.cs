...
namespace HC.Analytics.Colt
{
    ...
    */
    ...
    <p> This class , alternative 3. It operates on arbitrary shaped data. 
    ...
    <p> Sorts involving floating point data and not involving comparators, like, for 
      example provided in the JDK {@link Arrays} and in the Colt {@link 
      ...
      to comparators cannot do  They rely on the comparator. Thus, if such boundary 
    ...
    */
    ...
    [Serializable]
    public class GenericSorting : Object
    {
        ...
        private static void inplace_merge(int first, int middle, int last,
                                          IntComparator comp,
                                          Swapper swapper)
        {
        ...
        {
            //if (comp==null) throw new HCException();
            int len = last - first;
            while (len > 0)
            {
                int half = len/2;
        ...
        private static void quickSort1(int off, int len, IntComparator comp, Swapper swapper)
        {
            ...
            vecswap(swapper, off, b - s_, s_);
            s_ = Math.Min(d - c, n_ - d - 1);
            vecswap(swapper, b, n_ - s_, s_);

            // Recursively sort non-partition-elements
            if ((s_ = b - a) > 1)
            {
                quickSort1(off, s_, comp, swapper);
            }
            if ((s_ = d - c) > 1)
            {
                quickSort1(n_ - s_, s_, comp, swapper);
            }
        }
