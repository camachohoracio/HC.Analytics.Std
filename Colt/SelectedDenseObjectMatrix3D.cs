...
namespace HC.Analytics.Colt
{
    ...
    */
    ...
    public class SelectedDenseObjectMatrix3D : ObjectMatrix3D
    {
        ...
        public SelectedDenseObjectMatrix3D(Object[] elements, int[] sliceOffsets, int[] rowOffsets, int[] columnOffsets,
                                           int offset)
        {
        ...
        */
        ...
        public new ObjectMatrix2D viewRow(int row)
        {
            ...
            return new SelectedDenseObjectMatrix2D(viewRows, viewColumns, m_elements, viewRowZero, viewColumnZero,
        ...
        {
            return new SelectedDenseObjectMatrix3D(m_elements, sliceOffsets, rowOffsets, columnOffsets, m_offset);
        }
