...
namespace HC.Analytics.Colt
{
    ...
    */
    ...
    [Serializable]
    public abstract class AbstractIntObjectMap : AbstractMap
    {
        ...
        {
            return !forEachPair(
                        new IntObjectProcedure6_(value));
        }
        ...
        public override bool Equals(Object obj)
        {
            ...
            if (!(obj is AbstractIntObjectMap))
            {
                return false;
            }
            AbstractIntObjectMap other = (AbstractIntObjectMap) obj;
            if (other.Size() != Size())
            {
                return false;
            }
            ...
            return
                forEachPair(
                    new IntObjectProcedure_(other)
                    )
                &&
                other.forEachPair(
                    new IntObjectProcedure_(this)
                    );
        }
        ...
        public bool forEachPair(IntObjectProcedure procedure)
        {
            return forEachKey(
                new IntProcedure8_(procedure, this));
        }
        ...
        public int keyOf(Object value)
        {
            ...
            bool notFound = forEachPair(
                new IntObjectProcedure2_(value, foundKey));
            if (notFound)
            {
                return int.MinValue;
            }
        ...
        IntObjectProcedure condition = new IntObjectProcedure() { // match even keys only
            public bool Apply(int key, Object value) { return key%2==0; }
        }
        ...
        */
        ...
        public void pairsSortedByValue(IntArrayList keyList, ObjectArrayList valueList)
        {
            ...
            Swapper swapper = new Swapper8_(v, k);

            IntComparator comp = new IntComparator10_(k, v);
         ...
         */
        public abstract bool put(int key, Object value);
        /**
