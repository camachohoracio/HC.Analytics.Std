...
namespace HC.Analytics.Colt
{
    ...
    */
    ...
    [Serializable]
    public abstract class AbstractDoubleList : AbstractList, DoubleBufferConsumer
    {
        /**
        ...
        {
            double[] myElements = new double[m_size];
        ...
        public override void quickSortFromTo(int from, int to)
        {
            ...
            //Sorting.mergeSort(myElements, from, to+1); // TODO just for debugging
        ...
        */
        ...
        public bool removeAll(AbstractDoubleList other)
        {
            if (other.Size() == 0)
            {
        ...
        */
        ...
        public override void replaceFromWith(int from, CollectionBase other)
        {
            ...
            {
                e.MoveNext();
                set(index++, (double) e.Current); //delta
            }
        }
        ...
        */
        ...
        public bool retainAll(AbstractDoubleList other)
        {
            if (other.Size() == 0)
            {
                if (m_size == 0)
         ...
         * For example:
         * public DatabaseList : AbstractDoubleList {
         *    ...
