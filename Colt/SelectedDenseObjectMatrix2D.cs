...
namespace HC.Analytics.Colt
{
    ...
    */
    ...
    public class SelectedDenseObjectMatrix2D : ObjectMatrix2D
    {
        ...
        public SelectedDenseObjectMatrix2D(int m_intRows, int m_intColumns, Object[] elements, int rowZero,
        ...
        public override Object getQuick(int row, int column)
        {
            ...
            return
                m_elements[
                    m_offset + m_rowOffsets[m_rowZero + row*m_rowStride] +
        ...
        {
            return new DenseObjectMatrix2D(m_intRows, m_intColumns);
        }
        ...
        */
        ...
        public new ObjectMatrix1D viewColumn(int column)
        {
            ...
            return new SelectedDenseObjectMatrix1D(viewSize, m_elements, viewZero, viewStride, viewOffsets, viewOffset);
        }
        ...
        */
        ...
        {
            return new SelectedDenseObjectMatrix2D(m_elements, rowOffsets, columnOffsets, m_offset);
        }
    }
}
