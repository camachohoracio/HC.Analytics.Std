...
namespace HC.Analytics.Colt
{
    ...
    */
    ...
    ////import AbstractIntList;
    /**
     * Adapter that permits an {@link AbstractIntList} to be viewed and treated as a JDK 1.2 {@link AbstractList}.
     ...
     * Getter methods return <tt>java.lang.int</tt> objects.
     */

    [Serializable]
    public class IntListAdapter
    {
        public AbstractIntList m_content;
        /**
        ...
        public static Object object_(int element)
        {
            return element;
        }
