    ...
    public abstract class ObjectMatrix1D : AbstractMatrix1D
    {
        ...
        */
        ...
        public Object aggregate(ObjectObjectFunction aggr, ObjectFunction f)
        {
            ...
            Object a = f.Apply(getQuick(m_intSize - 1));
        ...
        */
        ...
        public Object aggregate(ObjectMatrix1D other, ObjectObjectFunction aggr, ObjectObjectFunction f)
        {
            ...
            Object a = f.Apply(getQuick(m_intSize - 1), other.getQuick(m_intSize - 1));
            for (int i = m_intSize - 1; --i >= 0;)
            {
        ...
        * same m_intSize, and all corresponding pairs of cells in the two matrices are the same.
        ...
        */
        ...
        public bool haveSharedCells(ObjectMatrix1D other)
        {
            if (other == null)
            {
                return false;
        ...
        public bool haveSharedCellsRaw(ObjectMatrix1D other)
        {
            return false;
        }
         ...
         * @return  a new empty matrix of the same dynamic type.
         */
        public abstract ObjectMatrix1D like(int m_intSize);
        /**
        ...
        */
        ...
        {
            Object[] values = new Object[m_intSize];
            ToArray(values);
            return values;
        }
        ...
        */
        ...
        &nbsp;&nbsp;&nbsp;new ObjectProcedure() {
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;public  bool Apply(Object a) { return a % 2 == 0; }
        &nbsp;&nbsp;&nbsp;}
        );
        -->
        matrix ==  0 2
        ...
        */
        ...
        For further information, see {@link Appendobjectalgo.Sorting#Sort(ObjectMatrix1D)}.
        ...
        */
        ...
        {
            return SortingObjectAlgo.mergeSort.Sort(this);
        }
