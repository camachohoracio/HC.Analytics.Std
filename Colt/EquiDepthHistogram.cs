...
namespace HC.Analytics.Colt
{
    ...
    */
    ...
    [Serializable]
    public class EquiDepthHistogram : PersistentObject
    {
        public float[] binBoundaries;
        /**
        ...
        {
            binBoundaries = quantileElements;
        }
         ...
         * @throws java.lang.ArgumentException if the element is not contained in any bin.
         */
        ...
        public static void test(float element)
        {
            float[] quantileElements = {
                                           50.0f, 100.0f, 200.0f, 300.0f, 1400.0f, 1500.0f, 1600.0f, 1700.0f, 1800.0f,
                                           1900.0f, 2000.0f
                                       };
            EquiDepthHistogram histo = new EquiDepthHistogram(quantileElements);
            PrintToScreen.WriteLine("elem=" + element + ", phi=" + histo.phi(element));
        }
    }
}
