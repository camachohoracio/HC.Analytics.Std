...
namespace HC.Analytics.Colt
{
    ...
    */
    ...
    public class SelectedDenseDoubleMatrix2D : DoubleMatrix2D
    {
        ...
        public SelectedDenseDoubleMatrix2D(int m_intRows, int m_intColumns, double[] elements, int rowZero,
        ...
        */
        ...
        public new DoubleMatrix1D viewColumn(int column)
        {
            ...
            return new SelectedDenseDoubleMatrix1D(viewSize, m_elements, viewZero, viewStride, viewOffsets, viewOffset);
        }
        ...
        */
        ...
        {
            return new SelectedDenseDoubleMatrix2D(m_elements, rowOffsets, columnOffsets, m_offset);
        }
    }
}
