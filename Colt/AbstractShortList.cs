...
namespace HC.Analytics.Colt
{
    ...
    */
    ...
    [Serializable]
    public abstract class AbstractShortList : AbstractList
    {
        /**
        ...
        {
            return binarySearchFromTo(key, 0, size - 1);
        }
        ...
        public bool contains(short elem)
        {
        ...
        {
            //delta
            if (!(otherObj is AbstractShortList))
            {
                return false;
            }
            if (this == otherObj)
        ...
        public bool forEach(ShortProcedure procedure)
        {
            for (int i = 0; i < size;)
            {
        ...
        */
        ...
        public bool removeAll(AbstractShortList other)
        {
            if (other.Size() == 0)
            {
        ...
        */
        ...
        public override void replaceFromWith(int from, CollectionBase other)
        {
            ...
            {
                e.MoveNext();
                set(index++, (short) (e.Current)); //delta
            }
        }
        ...
        */
        ...
        public bool retainAll(AbstractShortList other)
        {
            if (other.Size() == 0)
            {
                if (size == 0)
         ...
         * For example:
         * public DatabaseList : AbstractShortList {
         *    ...
