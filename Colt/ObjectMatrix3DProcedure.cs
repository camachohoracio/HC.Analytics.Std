namespace HC.Analytics.Colt
{
    ...
    */
     ...
     * a single argument and returns a bool value.
     */
    ...
    public interface ObjectMatrix3DProcedure
    {
         ...
         * Optionally can return a bool flag to inform the object calling the procedure.
         *
         ...
         */
        bool Apply(DoubleMatrix3D element);
        /**
         * Applies a procedure to an argument.
         * Optionally can return a bool flag to inform the object calling the procedure.
         *
         ...
         * @return a flag  to inform the object calling the procedure.
         */
        bool Apply(ObjectMatrix3D element);
    }
}
