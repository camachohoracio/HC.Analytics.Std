...
namespace HC.Analytics.Colt
{
    ...
    */
    ...
    ////import DateTime;
    /**
     * Same as <tt>MersenneTwister</tt> except that method <tt>NextDouble()</tt> returns 64 bit random numbers instead of 32 bit random numbers.
     * 
    ...
    public class MersenneTwister64 : MersenneTwister
    {
        ...
        public MersenneTwister64(DateTime d)
            : base(d)
        {
        }
