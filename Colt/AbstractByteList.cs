...
namespace HC.Analytics.Colt
{
    ...
    */
    ...
    [Serializable]
    public abstract class AbstractByteList : AbstractList
    {
        /**
        ...
        public bool contains(byte elem)
        {
        ...
        {
            byte[] myElements = new byte[m_intSize];
        ...
        {
            //delta
            if (!(otherObj is AbstractByteList))
            {
                return false;
            }
            if (this == otherObj)
        ...
        public bool forEach(ByteProcedure procedure)
        {
         ...
         * @throws HCException index is out of range (index
         * 		  &lt; 0 || index &gt;= Size()).
         */
        ...
        */
        ...
        public bool removeAll(AbstractByteList other)
        {
            if (other.Size() == 0)
            {
        ...
        */
        ...
        public void replaceFromWith(int from, ICollection other)
        {
            ...
            {
                e.MoveNext();
                set(index++, (byte) e.Current); //delta
            }
        }
        ...
        */
        ...
        public bool retainAll(AbstractByteList other)
        {
            if (other.Size() == 0)
            {
                if (m_intSize == 0)
         ...
         * @exception HCException if <tt>index &lt; 0 || index &gt;= Size()</tt>.
         */
         ...
         * For example:
         * public DatabaseList : AbstractByteList {
         *    ...
