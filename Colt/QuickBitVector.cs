...
namespace HC.Analytics.Colt
{
    ...
    */
    ...
    [Serializable]
    public class QuickBitVector : Object
    {
        ...
        public static long[] pows = precomputePows(); //precompute bitmasks for speed
        /**
        ...
        public static bool get(long[] bits, int bitIndex)
        {
        ...
        */
        ...
        private static long[] precomputePows()
        {
            ...
            for (int i = BITS_PER_UNIT + 1; --i >= 1;)
            {
                ...
                //PrintToScreen.WriteLine((i)+":"+pows[i]);
            }
            pows[0] = 0L;
            //PrintToScreen.WriteLine((0)+":"+pows[0]);
            return pows;
            ...
            */
            ...
            PrintToScreen.WriteLine((BITS_PER_UNIT-1)+":"+pows[BITS_PER_UNIT-1]);
            return pows;
            */
        }
        ...
        public static void put(long[] bits, int bitIndex, bool value)
        {
            if (value)
            {
                set(bits, bitIndex);
