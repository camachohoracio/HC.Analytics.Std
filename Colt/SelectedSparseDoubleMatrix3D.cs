...
namespace HC.Analytics.Colt
{
    ...
    */
    ...
    public class SelectedSparseDoubleMatrix3D : DoubleMatrix3D
    {
        ...
        public SelectedSparseDoubleMatrix3D(AbstractIntDoubleMap elements, int[] sliceOffsets, int[] rowOffsets,
        ...
        {
            return new SparseDoubleMatrix3D(m_intSlices, m_intRows, m_intColumns);
        }
        ...
        */
        ...
        public new DoubleMatrix2D viewColumn(int column)
        {
            ...
            return new SelectedSparseDoubleMatrix2D(viewRows, viewColumns, m_elements, viewRowZero, viewColumnZero,
        ...
        */
        ...
        {
            return new SelectedSparseDoubleMatrix3D(m_elements, sliceOffsets, rowOffsets, columnOffsets, m_offset);
        }
