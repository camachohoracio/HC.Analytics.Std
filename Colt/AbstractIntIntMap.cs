...
namespace HC.Analytics.Colt
{
    ...
    */
    ...
    [Serializable]
    public abstract class AbstractIntIntMap : AbstractMap
    {
        ...
        public override bool Equals(Object obj)
        {
            ...
            if (!(obj is AbstractIntIntMap))
            {
                return false;
            }
            AbstractIntIntMap other = (AbstractIntIntMap) obj;
            if (other.Size() != Size())
            {
                return false;
            }
            ...
            return
                forEachPair(
                    new IntIntProcedure2_(other)
                    )
                &&
                other.forEachPair(
                    new IntIntProcedure2_(this)
                    );
        }
        ...
        public bool forEachPair(IntIntProcedure procedure)
        {
            return forEachKey(
                new IntIntProcedure3_(
                    procedure,
                    this));
        }
        ...
        public int keyOf(int value)
        {
            ...
            bool notFound = forEachPair(
                new IntIntProcedure4_(value, foundKey));
            if (notFound)
            {
                return int.MinValue;
            }
        ...
        IntIntProcedure condition = new IntIntProcedure() { // match even keys only
            public bool Apply(int key, int value) { return key%2==0; }
        }
        ...
        */
        ...
        public void pairsSortedByValue(IntArrayList keyList, IntArrayList valueList)
        {
            ...
            Swapper swapper = new Swapper11_(
                v,
                k);

            IntComparator comp = new IntComparator13_(k, v);
         ...
         */
        public abstract bool put(int key, int value);
        /**
