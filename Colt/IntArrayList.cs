...
namespace HC.Analytics.Colt
{
    ...
    */
    ...
    public class IntArrayList : AbstractIntList
    {
        ...
        public IntArrayList(int[] elements_)
        {
            elements(elements_);
        }
        ...
        public new void beforeInsert(int index, int element)
        {
            // overridden for performance only.
            if (m_intSize == index)
            {
        ...
        public new int binarySearchFromTo(int key, int from, int to)
        {
            return Sorting.binarySearchFromTo(elements_, key, from, to);
        }
        ...
        */
        ...
        public new AbstractIntList elements(int[] elements)
        {
            elements_ = elements;
        ...
        public new bool forEach(IntProcedure procedure)
        {
            // overridden for performance only.
            int[] theElements = elements_;
        ...
        public override int getQuick(int index)
        {
            return elements_[index];
        }
        ...
        public new int indexOfFromTo(int element, int from, int to)
        {
            // overridden for performance only.
            if (m_intSize == 0)
            {
        ...
        public new int lastIndexOfFromTo(int element, int from, int to)
        {
            // overridden for performance only.
            if (m_intSize == 0)
            {
        ...
        public new AbstractIntList partFromTo(int from, int to)
        {
            if (m_intSize == 0)
            {
        ...
        */
        ...
        public new bool removeAll(AbstractIntList other)
        {
            // overridden for performance only.
        ...
        public new void replaceFromToWithFrom(int from, int to, AbstractIntList other, int otherFrom)
        {
            // overridden for performance only.
            if (!(other is IntArrayList))
            {
            ...
            if (Length > 0)
            {
                ...
                Array.Copy(((IntArrayList) other).elements_, otherFrom, elements_, from, Length);
            }
        }
        ...
        */
        ...
        public new bool retainAll(AbstractIntList other)
        {
            // overridden for performance only.
            if (!(other is IntArrayList))
            {
        ...
        public new void set(int index, int element)
        {
            // overridden for performance only.
            if (index >= m_intSize || index < 0)
            {
        ...
        public override void setQuick(int index, int element)
        {
            elements_[index] = element;
        }
        ...
        public new void sortFromTo(int from, int to)
        {
            ...
            int min = elements_[from];
            int max = elements_[from];
