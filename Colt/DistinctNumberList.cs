...
namespace HC.Analytics.Colt
{
    ...
    */
     ...
     * Any attempt to violate the contract will throw an <tt>ArgumentException</tt>.
     * <p>
    ...
    [Serializable]
    public abstract class DistinctNumberList : AbstractLongList
    {
        public long[] m_distinctValues;
        public MinMaxNumberList m_elements;
        ...
        {
            int index = Array.BinarySearch(m_distinctValues, element);
            if (index < 0)
            {
                throw new ArgumentException("Element=" + element + " not contained in distinct elements.");
            }
            return index;
        }
        ...
        {
            return m_distinctValues[(int) (m_elements.getQuick(index))];
        }
        ...
        public new void removeFromTo(int from, int to)
        {
            m_elements.removeFromTo(from, to);
            size -= to - from + 1;
        }
        ...
        {
            m_elements.setQuick(index, codeOf(element));
        }
        ...
        public void setUp(long[] distinctValues, int initialCapacity)
        {
            ...
            m_elements = new MinMaxNumberList(0, distinctValues.Length - 1, initialCapacity);
        }
