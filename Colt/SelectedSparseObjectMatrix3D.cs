...
namespace HC.Analytics.Colt
{
    ...
    */
    ...
    public class SelectedSparseObjectMatrix3D : ObjectMatrix3D
    {
        ...
        public SelectedSparseObjectMatrix3D(AbstractIntObjectMap elements, int[] sliceOffsets, int[] rowOffsets,
        ...
        public override Object getQuick(int slice, int row, int column)
        {
            ...
            //manually inlined:
            return
                m_elements.get(m_offset + m_sliceOffsets[m_sliceZero + slice*m_sliceStride] +
                               m_rowOffsets[m_rowZero + row*m_rowStride] +
        ...
        {
            return new SparseObjectMatrix3D(m_intSlices, m_intRows, m_intColumns);
        }
        ...
        public override void setQuick(int slice, int row, int column, Object value)
        {
            ...
            //manually inlined:
            int index = m_offset + m_sliceOffsets[m_sliceZero + slice*m_sliceStride] +
                        m_rowOffsets[m_rowZero + row*m_rowStride] +
                        m_columnOffsets[m_columnZero + column*m_columnStride];
            if (value == null)
            {
         ...
         * @param m_intRows the number of m_intRows the matrix shall have.
         * @param m_intColumns the number of m_intColumns the matrix shall have.
         * @throws	ArgumentException if <tt>(Object)m_intRows*m_intSlices > int.MaxValue</tt>.
         */
        ...
        */
        ...
        public new ObjectMatrix2D viewColumn(int column)
        {
            ...
            return new SelectedSparseObjectMatrix2D(viewRows, viewColumns, m_elements, viewRowZero, viewColumnZero,
        ...
        */
        ...
        {
            return new SelectedSparseObjectMatrix3D(m_elements, sliceOffsets, rowOffsets, columnOffsets, m_offset);
        }
