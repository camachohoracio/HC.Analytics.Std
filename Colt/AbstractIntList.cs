...
namespace HC.Analytics.Colt
{
    ...
    */
    ...
    [Serializable]
    public abstract class AbstractIntList : AbstractList, IntBufferConsumer
    {
        /**
        ...
        public int[] elements()
        {
            int[] myElements = new int[m_intSize];
        ...
        public bool forEach(IntProcedure procedure)
        {
        ...
        */
        ...
        public bool removeAll(AbstractIntList other)
        {
            if (other.Size() == 0)
            {
        ...
        */
        ...
        public bool retainAll(AbstractIntList other)
        {
            if (other.Size() == 0)
            {
                if (m_intSize == 0)
         ...
         * For example:
         * public DatabaseList : AbstractIntList {
         *    ...
