...
namespace HC.Analytics.Colt
{
    ...
    */
    ...
    [Serializable]
    public class Descriptive : Object
    {
        /**
        ...
        public static double autoCorrelation(DoubleArrayList data, int lag, double mean, double variance)
        {
            ...
            if (lag >= N)
            {
                throw new ArgumentException("Lag is too large");
            }
        ...
        public static double durbinWatson(DoubleArrayList data)
        {
            ...
            if (size < 2)
            {
                throw new ArgumentException("data sequence must contain at least two values.");
            }
         ...
         * <ul>
         * <li><tt>inOut[0] = Double.PositiveInfinity</tt> as the old minimum.
         * <li><tt>inOut[1] = Double.NegativeInfinity</tt> as the old maximum.
         ...
         * <br><tt>b(k,i) = </tt>{@link Arithmetic#binomial(long,long) binomial(k,i)} and
                                                         ...
                                                         int toSumIndex, double[] sumOfPowers)
        {
            ...
            double[] elements2 = data.elements();

            for (int i = from - 1; ++i <= to;)
            {
                double element = elements2[i];
                                                     ...
                                                     double[] inOut)
        {
            ...
            {
                throw new ArgumentException("from=" + from + ", to=" + to + ", data.Size()=" + dataSize +
        ...
        public static double rankInterpolated(DoubleArrayList sortedList, double element)
        {
            ...
            if (index >= 0)
            {
                ...
                while (to2 < s && sortedList.get(to2) == element)
                {
                    to2++;
                }
                return to2;
         ...
         *
         * Ref: R.R. Sokal, Functions.J. Rohlf, Biometry: the principles and practice of statistics
         * in biological research (W.H. Freeman and HC, New York, 1998, 3rd edition)
         * p. 114-115.
         *
         * @param size the number of elements of the data sequence.
         * @param moment4 the fourth central moment, which is <tt>moment(data,4,mean)</tt>.
        ...
        public static double sampleStandardDeviation(int size, double sampleVariance)
        {
            ...
            {
                Cn = Math.Sqrt((n - 1)*0.5)*GammaFunct.Gamma((n - 1)*0.5)/GammaFunct.Gamma(n*0.5);
            }
            return Cn*s;
        }
