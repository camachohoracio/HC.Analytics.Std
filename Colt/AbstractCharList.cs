...
namespace HC.Analytics.Colt
{
    ...
    */
    ...
    [Serializable]
    public abstract class AbstractCharList : AbstractList
    {
        /**
        ...
        {
            beforeInsertAllOfFromTo(m_size, other, from, to);
        }
        ...
        public override void beforeInsertDummies(int index, int Length)
        {
            ...
            if (Length > 0)
            {
                ...
                setSizeRaw(m_size + Length);
                replaceFromToWithFrom(index + Length, m_size - 1, this, index);
            }
        }
        ...
        {
            return binarySearchFromTo(key, 0, m_size - 1);
        }
        ...
        {
            return indexOfFromTo(elem, 0, m_size - 1) >= 0;
        }
        ...
        {
            int index = indexOfFromTo(element, 0, m_size - 1);
            if (index >= 0)
            {
                remove(index);
            }
        ...
        {
            char[] myElements = new char[m_size];
        ...
        public AbstractCharList elements(char[] elementsArr)
        {
            Clear();
            addAllOfFromTo(new CharArrayList(elementsArr), 0, elementsArr.Length - 1);
            return this;
        }
        ...
        {
            //delta
            if (!(otherObj is AbstractCharList))
            {
                return false;
            }
            if (this == otherObj)
        ...
        public bool forEach(CharProcedure procedure)
        {
        ...
        {
            //delta
            return indexOfFromTo(element, 0, m_size - 1);
        }
        ...
        {
            return lastIndexOfFromTo(element, 0, m_size - 1);
        }
        ...
        */
        ...
        public bool removeAll(AbstractCharList other)
        {
            if (other.Size() == 0)
            {
        ...
        */
        ...
        public void replaceFromWith(int from, ICollection other)
        {
            ...
            {
                e.MoveNext();
                set(index++, (Char) e.Current); //delta
            }
        }
        ...
        */
        ...
        public bool retainAll(AbstractCharList other)
        {
            if (other.Size() == 0)
            {
                if (m_size == 0)
         ...
         * For example:
         * public DatabaseList : AbstractCharList {
         *    ...
         *    public void removeFromTo(int from,int to) {
         *       myDatabase.removeFromTo(from,to);
         *       setSizeRaw(size-(to-from+1));
         *    }
         * }
         */
