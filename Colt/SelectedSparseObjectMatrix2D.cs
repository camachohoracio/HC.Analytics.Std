...
namespace HC.Analytics.Colt
{
    ...
    */
    ...
    public class SelectedSparseObjectMatrix2D : ObjectMatrix2D
    {
        ...
        public SelectedSparseObjectMatrix2D(int m_intRows, int m_intColumns, AbstractIntObjectMap elements, int rowZero,
        ...
        public SelectedSparseObjectMatrix2D(AbstractIntObjectMap elements, int[] rowOffsets, int[] columnOffsets,
                                            int offset)
        ...
        public override ObjectMatrix2D like(int m_intRows, int m_intColumns)
        {
            return new SparseObjectMatrix2D(m_intRows, m_intColumns);
        }
         ...
         * @param m_intRows the number of m_intRows the matrix shall have.
         * @param m_intColumns the number of m_intColumns the matrix shall have.
         * @throws	ArgumentException if <tt>(Object)m_intColumns*m_intRows > int.MaxValue</tt>.
         */
        ...
        */
        ...
        public new ObjectMatrix1D viewColumn(int column)
        {
            ...
            return new SelectedSparseObjectMatrix1D(viewSize, m_elements, viewZero, viewStride, viewOffsets, viewOffset);
        }
        ...
        */
        ...
        {
            return new SelectedSparseObjectMatrix2D(m_elements, rowOffsets, columnOffsets, m_offset);
        }
    }
}
