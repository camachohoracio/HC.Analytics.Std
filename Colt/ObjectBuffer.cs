...
namespace HC.Analytics.Colt
{
    ...
    */
    ...
    [Serializable]
    public class ObjectBuffer : PersistentObject, ObjectBufferConsumer
    {
        public int m_capacity;
        public Object[] m_elements;

        // vars cached for speed
        public ObjectArrayList m_list;
        public int m_size;
        public ObjectBufferConsumer m_target;
        /**
        ...
        public ObjectBuffer(ObjectBufferConsumer target, int capacity)
        {
            ...
            m_list = new ObjectArrayList(m_elements);
            m_size = 0;
        }
        ...
        #region ObjectBufferConsumer Members
