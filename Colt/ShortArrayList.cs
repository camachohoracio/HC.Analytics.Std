...
namespace HC.Analytics.Colt
{
    ...
    */
    ...
    public class ShortArrayList : AbstractShortList
    {
        ...
        public ShortArrayList(short[] elements_)
        {
            elements(elements_);
        }
        ...
        public new void Add(short element)
        {
        ...
        public new void beforeInsert(int index, short element)
        {
            // overridden for performance only.
        ...
        public new int binarySearchFromTo(short key, int from, int to)
        {
        ...
        {
            // overridden for performance only.
            ShortArrayList Clone = new ShortArrayList((short[]) m_elements.Clone());
        ...
        */
        ...
        public new AbstractShortList elements(short[] elements)
        {
            m_elements = elements;
        ...
        public new bool forEach(ShortProcedure procedure)
        {
            // overridden for performance only.
            short[] theElements = m_elements;
            int theSize = size;
        ...
        public new short get(int index)
        {
            // overridden for performance only.
            if (index >= size || index < 0)
            {
        ...
        public override short getQuick(int index)
        {
            return m_elements[index];
        }
        ...
        public new int indexOfFromTo(short element, int from, int to)
        {
            // overridden for performance only.
            if (size == 0)
            {
        ...
        public new int lastIndexOfFromTo(short element, int from, int to)
        {
            // overridden for performance only.
            if (size == 0)
            {
        ...
        public new AbstractShortList partFromTo(int from, int to)
        {
            if (size == 0)
            {
        ...
        */
        ...
        public new bool removeAll(AbstractShortList other)
        {
            // overridden for performance only.
        ...
        public new void replaceFromToWithFrom(int from, int to, AbstractShortList other, int otherFrom)
        {
            // overridden for performance only.
            if (!(other is ShortArrayList))
            {
            ...
            if (Length > 0)
            {
                ...
                Array.Copy(((ShortArrayList) other).m_elements, otherFrom, m_elements, from, Length);
            }
        }
        ...
        */
        ...
        public new bool retainAll(AbstractShortList other)
        {
            // overridden for performance only.
            if (!(other is ShortArrayList))
            {
        ...
        public new void set(int index, short element)
        {
            // overridden for performance only.
            if (index >= size || index < 0)
            {
        ...
        public override void setQuick(int index, short element)
        {
            m_elements[index] = element;
        }
        ...
        public new void sortFromTo(int from, int to)
        {
            ...
            short min = m_elements[from];
            short max = m_elements[from];
