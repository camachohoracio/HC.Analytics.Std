...
namespace HC.Analytics.Colt
{
    ...
    */
    ...
    [Serializable]
    public class Partitioning2 : Object
    {
        ...
        */
        ...
        private static int binarySearchFromTo(
            int a,
            int from,
            int to,
            IntComparator comp)
        ...
        */
        ...
        public static void genericPartition(int from, int to, int splitFrom, int splitTo, int[] splitIndexes,
                                            IntComparator comp, IntComparator comp2, IntComparator comp3,
                                            Swapper swapper)
        {
            int splitter; // int, double --> template type dependent
        ...
        */
        ...
        public static int partition(Object[] list, int from, int to, Object splitter,
                                    Comparer comp)
        {
        ...
        public static void partition(IntArrayList list, int from, int to, IntArrayList splitters,
                                     IntArrayList splitIndexes)
        {
            partition(list.elements(), from, to, splitters.elements(), 0, splitters.Size() - 1, splitIndexes.elements());
        }
        ...
        public static void triplePartition(int[] list, int[] secondary, int[] tertiary, int from, int to,
                                           int[] splitters, int splitFrom, int splitTo, int[] splitIndexes)
        {
            int splitter; // int, double --> template type dependent
