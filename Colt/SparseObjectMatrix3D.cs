...
namespace HC.Analytics.Colt
{
    ...
    */
    ...
    public class SparseObjectMatrix3D : ObjectMatrix3D
    {
         ...
         * @throws	ArgumentException if <tt>(Object)slices*columns*rows > int.MaxValue</tt>.
         * @throws	ArgumentException if <tt>slices<0 || rows<0 || columns<0</tt>.
         */

        public SparseObjectMatrix3D(int slices, int rows, int columns, AbstractIntObjectMap elements, int sliceZero,
        ...
        public override ObjectMatrix2D like2D(int rows, int columns, int rowZero, int columnZero, int rowStride,
                                              int columnStride)
        {
            return new SparseObjectMatrix2D(rows, columns, m_elements, rowZero, columnZero, rowStride, columnStride);
        }
        ...
        {
            return new SelectedSparseObjectMatrix3D(m_elements, sliceOffsets, rowOffsets, columnOffsets, 0);
        }
    }
}
