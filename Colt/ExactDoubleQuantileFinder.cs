...
namespace HC.Analytics.Colt
{
    ...
    */
     ...
     */
    //class ExactDoubleQuantileFinder : Object : DoubleQuantileFinder {
    [Serializable]
    public class ExactDoubleQuantileFinder : PersistentObject, DoubleQuantileFinder
    {
        public DoubleArrayList m_buffer;
        public bool m_isSorted;
        /**
        ...
        {
            m_buffer = new DoubleArrayList(0);
            Clear();
        }
        ...
        {
            m_buffer.addAllOfFromTo(values, from, to);
            m_isSorted = false;
        }
        ...
        public new Object Clone()
        {
            ...
            if (m_buffer != null)
            {
                copy.m_buffer = copy.m_buffer.Copy();
            }
            return copy;
        }
        ...
        {
            double[] theElements = m_buffer.elements();
        ...
        public long memory()
        {
            return m_buffer.elements().Length;
        }
        ...
        {
            Sort();
            return Descriptive.rankInterpolated(m_buffer, element)/Size();
        }
        ...
        {
            Sort();
            return Descriptive.quantiles(m_buffer, phis);
            /*
        ...
        {
            Sort();
            return m_buffer.binarySearch(element) >= 0;
        }
