...
namespace HC.Analytics.Colt
{
    ...
    */
    ...
    [Serializable]
    public abstract class AbstractLongList : AbstractList
    {
        /**
        ...
        public bool forEach(LongProcedure procedure)
        {
            for (int i = 0; i < size;)
            {
        ...
        */
        ...
        public bool removeAll(AbstractLongList other)
        {
            if (other.Size() == 0)
            {
        ...
        */
        ...
        public override void replaceFromWith(int from, CollectionBase other)
        {
            ...
            {
                e.MoveNext();
                set(index++, (long) (e.Current)); //delta
            }
        }
        ...
        */
        ...
        public bool retainAll(AbstractLongList other)
        {
            if (other.Size() == 0)
            {
                if (size == 0)
         ...
         * For example:
         * public DatabaseList : AbstractLongList {
         *    ...
