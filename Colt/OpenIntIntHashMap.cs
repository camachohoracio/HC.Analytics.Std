...
namespace HC.Analytics.Colt
{
    ...
    */
    ...
    [Serializable]
    public class OpenIntIntHashMap : AbstractIntIntMap
    {
        /**
        * The hash table keys.
        * @serial
        ...
        */
        ...
        {
            OpenIntIntHashMap copy = (OpenIntIntHashMap) base.Clone();
            copy.m_table = (int[]) copy.m_table.Clone();
        ...
        *
        ...
        public new bool forEachPair(IntIntProcedure procedure)
        {
            for (int i = m_table.Length; i-- > 0;)
            {
                if (m_state[i] == FULL)
        ...
        {
            //PrintToScreen.WriteLine("key="+key);
            int[] tab = m_table;
            byte[] stat = m_state;
        ...
        public new int keyOf(int value)
        {
        ...
        */
        ...
        public new void pairsMatching(IntIntProcedure condition, IntArrayList keyList, IntArrayList valueList)
        {
            keyList.Clear();
            valueList.Clear();
