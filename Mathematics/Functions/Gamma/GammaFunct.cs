...
{
    public class GammaFunct : AFunction2D
    {
        #region Members
        ...
        public const string STR_PRECOMPILED_DATA_FILE_NAME = "precompiledBeta";
        ...
        public static double Gamma(double x)
        {
            ...
            return double.IsInfinity(dblGammaValue) ? double.MaxValue : dblGammaValue;
        }
