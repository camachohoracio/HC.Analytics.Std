...
namespace HC.Analytics.Mathematics
{
    ...
    public class Arithmetic
    {
        ...
        private static readonly double[] stirlingCorrectionArray = {
                                                                       0.0,
        ...
        private static long fac1(int j)
        {
            ...
            {
                //Debugger.Break();
                throw new HCException("Overflow");
            }
            long d = 1;
            while (i > 1)
            {
        ...
        {
            return (long) Math.Round(Math.Floor(value));
        }
        ...
        public static double Log(double dblBase, double value)
        {
            return Math.Log(value)/Math.Log(dblBase);
        }
        ...
        public static long longFactorial(int k)
        {
            if (k < 0)
            {
                throw new HCException("Negative k");
            }
        ...
        public static double stirlingCorrection(int k)
        {
            ...
            {
                return stirlingCorrectionArray[k];
            }
        }
        ...
        {
            return (long) Math.Round(Binomial(n, k));
        }
    }
}
