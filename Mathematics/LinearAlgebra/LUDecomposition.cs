    ...
    */
    ...
    public class LUDecomposition
    {
        ...
        */
        ...
        public LUDecomposition(MatrixClass A)
        {
            ...
            for (int j = 0; j < n; j++)
            {
                ...
                for (int i = 0; i < m; i++)
                {
                    LUrowi = ArrayHelper.GetRowCopy(LU, i);
        ...
        */
        ...
        /** Determinant
        @return     det(A)
        @exception  HCException  Matrix must be square
        */
        ...
        public double det()
        {
            if (m != n)
            {
                throw new HCException("Matrix must be square.");
            }
            double d = pivsign;
            for (int j = 0; j < n; j++)
            {
        ...
        */
        ...
        public MatrixClass solve(MatrixClass B)
        {
            ...
            {
                throw new HCException("Matrix row dimensions must agree.");
            }
            if (!IsNonsingular())
            {
                throw new HCException("Matrix is singular.");
            }

            // Copy right hand side with pivoting
            int nx = B.GetColumnDimension();
            MatrixClass Xmat = B.getMatrix(piv, 0, nx - 1);
